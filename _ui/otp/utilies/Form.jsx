...
function Form() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        router.push("/signin/forgetpassword/resetpassword")
    }
    return (
        <form onSubmit={handleSubmit} className='mt-clamp-48'>
            <div className='flex flex-col gap-clamp-24'>

                {/* email  */}
                <div>
                    <input type='text' className='input' placeholder='Enter the code *' />
                </div>
