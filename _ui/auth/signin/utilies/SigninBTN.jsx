...
function SigninBTN({ loading }) {

    return (
        <button disabled={loading} className={`hover:bg-full border border-gold100 transition-all duration-300 ease-in-out bg-gold100 h-clamp-56 flex gap-clamp-10 py-clamp-16 px-clamp-28 text-clamp-18 font-bold text-balance uppercase leading-[0.7] rounded-[2px] w-full text-center justify-center items-center uppercase`}>
            Sign in
            {
                loading ?
                    <svg
