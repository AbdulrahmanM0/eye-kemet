            ...
            <AuthBackdrop>
                <section className='max-w-[clamp(500px,76.82vw,1475px)] my-auto relative z-10'>
                    <div className='mb-[clamp(40px,6.25vw,120px)]'>
                        <h2 className='text-[clamp(30px,6.46vw,124px)] font-bold leading-[1.2] uppercase text-light400 text-center'>
                    ...
                    <div className='flex flex-wrap justify-center md:justify-between gap-clamp-40'>
                        {/* slogann  */}
                        <p className='text-clamp-18 text-light200 max-w-[clamp(250px,25.68vw,493px)] leading-[1.7]'>
                ...
                <div className='absolute top-1/2 -translate-y-1/2'>
                    ...
                    <div className="absolute inset-0 z-10 bg-[radial-gradient(44.53%_60.68%_at_48.1%_57.12%,_rgba(0,0,0,0)_0%,_#000_100%)]">
