            ...
            <div className='px-[clamp(20px,5.208vw,100px)] bg-full'>
                <div className='py-[clamp(20px,5.208vw,100px)]'>
                    ...
                    <div className='mx-auto max-w-[clamp(300px,68.36vw,1311px)]'>
                        <h3 className="text-balance text-clamp-96 leading-[0.7] mb-clamp-28 font-bold uppercase">
                            The Horus
                        </h3>
                        <div className='grid gap-clamp-28 md:gap-0 grid-cols-1 md:grid-cols-2'>
                            ...
                            <div className="flex flex-col gap-clamp-64">
                                <h3 className="text-gold100 text-clamp-96 leading-[0.7] font-bold uppercase md:flex gap-clamp-32">
                                ...
                                <p className="text-clamp-18 text-gray200 max-w-[clamp(300px,24.32vw,467px)] mb-clamp-30 me-clamp-30 ms-auto">
