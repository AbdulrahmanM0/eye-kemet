...
const cartItems = [
    { id: 1, name: "Ring Waterdrop", size: 15, price: 2800, qty: 1 },
    { id: 2, name: "Ring Waterdrop", size: 20, price: 3200, qty: 2 },
]
            ...
            >
                ...
                <DrawerHeader className="flex items-center justify-between py-clamp-10 p-0">
                    <DrawerTitle className="p-0">
                        <h5 className="text-light100 font-bold text-clamp-28 uppercase leading-none">Shopping Cart</h5>
                    </DrawerTitle>
                    <DrawerClose asChild>
                        <div className="flex gap-clamp-10">
                            <button className="underline text-gold100 text-clamp-16 font-bold ">
                                Empty Cart
                            </button>
                            <button
                ...
                <div className=" mt-clamp-18">
                    ...
                    <div className="flex flex-col gap-clamp-18">
                        <h6 className="leading-[0.7] text-light400 text-clamp-16">
                            Discounts
                        </h6>

                        <div className="px-clamp-24 py-clamp-14 bg-gold100">
                            <Discounts />
                        </div>
                    </div>
                    ...
                    <div className="p-clamp-24 bg-gray400 mt-clamp-18">
                        <div className="flex items-center gap-clamp-10">
                            ...
                            <p className="text-clamp-14 text-light100 h-fit">
                                You’re 2,500 EGP Away From Free Shipping
                            </p>
                        </div>
                        {/* performance  */}
                        <div className="h-[6px] bg-gray300 mt-clamp-10">
                ...
                <div className="flex-1 overflow-y-auto no-scrollbar py-clamp-20 flex flex-col">
                    {cartItems.length === 0 ? (
                        <p className="text-gray200 text-clamp-16 text-center mt-auto mb-auto">
                            Your cart is empty.
                        </p>
                    ) : (
                        cartItems.map((item) => (
                            <div key={item.id} className="flex gap-clamp-16 border-b border-gray400 py-clamp-20">
                                ...
                                <div className="relative w-[clamp(90px,6.875vw,132px)] h-auto bg-full rounded-[2px] shrink-0 flex items-center justify-center">
                                    <Image src={"/images/products/prod1.png"} className="object-cover bg-full" fill alt={item.name} />
                                </div>

                                <div className="flex flex-col gap-clamp-10 flex-1">
                                    <p className="text-light400 font-bold text-clamp-28 leading-none uppercase">
                                        {item.name}
                                    </p>
                                    ...
                                    <div className="flex items-center gap-clamp-20 mt-auto">
                                        {/* Qty controls */}
                                        <div className="flex items-center gap-clamp-10 border border-gray400 rounded-[2px] bg-gray400 w-fit">
                                            <button className="px-clamp-10 py-clamp-6 text-gold100 hover:text-light400 transition-colors text-clamp-16">−</button>
                                            <span className="text-light400 text-clamp-14 min-w-[20px] text-center">{item.qty}</span>
                                            <button className="px-clamp-10 py-clamp-6 text-gold100 hover:text-light400 transition-colors text-clamp-16">+</button>
                                        </div>
                                        <span className="text-light400 font-bold text-clamp-18 leading-none">
                                ...
                                {/* Remove */}
                                <button className="text-gray200 hover:text-light400 transition-colors self-start shrink-0">
                ...
                <div className="flex flex-col gap-clamp-24 mt-clamp-24">
                    <div className="text-clamp-20 text-light400 font-bold uppercase">
                        Payment Summary
                    </div>
                    {/*1 sub total */}
                    ...
                    {/* note  */}
                    <p className="text-clamp-16 text-gray200 leading-none text-center">
